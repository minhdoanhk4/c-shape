...
using CFMS.DeliveryService.Infrastructure.Repositories;
...
Log.Logger = new LoggerConfiguration()
    ...
    .Enrich.WithProperty("Application", "DeliveryService")
...
builder.Services.AddDbContext<DeliveryDbContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("CFMS_DeliveryDb")));
