...
using CFMS.PaymentService.Infrastructure.ExternalServices;
using CFMS.PaymentService.Infrastructure.Repositories;
...
builder.Services.AddDbContext<PaymentDbContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("CFMS_PaymentDb")));

// DI
builder.Services.AddScoped<IPaymentGatewayService, MockVNPayService>(); // Đăng ký cổng VNPay
