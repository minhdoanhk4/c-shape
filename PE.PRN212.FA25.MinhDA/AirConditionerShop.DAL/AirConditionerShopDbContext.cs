...
public partial class AirConditionerShopDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AirConditionerId).HasName("PK__AirCondi__EE2EB73920D679F9");
        ...
        {
            entity.HasKey(e => e.MemberId).HasName("PK__StaffMem__0CF04B38FC31DAA7");

            entity.ToTable("StaffMember");

            entity.HasIndex(e => e.EmailAddress, "UQ__StaffMem__49A14740BF28A97A").IsUnique();
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE666B4B9476820");
